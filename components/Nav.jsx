    ...
    <nav className='nav'>
          ...
          <section className='nav-bottom'>
            ...
            <ul className="navbar">
                ...
                <li className='nav-mujer'><Link href="/genero/mujer">Mujer</Link></li>
                <li className='nav-hombre'><Link href="/genero/hombre">Hombre</Link></li>
                <li className='nav-admin'><Link href="/tipo/faldas">Faldas</Link></li>
                <li className='nav-admin'><Link href="/tipo/pantalon">Pantalones</Link></li>
                <li className='nav-admin'><Link href="/tipo/franela">Franelas</Link></li>
