...
export default function Grid() {
  return (
    ...
    <Card className="col-span-12 sm:col-span-4 h-[300px]">
      <CardHeader className="absolute z-10 top-1 flex-col !items-start">
        <p style={{fontSize: '18px'}} className="text-tiny text-white/60 uppercase font-bold ">Hombre</p>
    ...
    <Card  className="col-span-12 sm:col-span-4 h-[300px]">
      <CardHeader className="absolute z-10 top-1 flex-col !items-start">
        <p style={{fontSize: '18px'}} className="text-tiny text-white/60 uppercase font-bold ">Zapatos</p>
    ...
    <Card isFooterBlurred className="w-full h-[300px] col-span-12 sm:col-span-5">
      <CardHeader className="absolute z-10 top-1 flex-col items-start">
        <p style={{fontSize: '18px'}} className="text-tiny text-white/60 uppercase font-bold">New</p>
    ...
    <Card isPressable isFooterBlurred className="w-full h-[300px] col-span-12 sm:col-span-7">
      <CardHeader className="absolute z-10 top-1 flex-col items-start">
        <p style={{fontSize: '18px'}} className="text-tiny text-white/60 uppercase font-bold">Explora aqui</p>
      ...
      <CardFooter className="absolute bg-black/40 bottom-0 z-10 border-t-1 border-default-600 dark:border-default-100">
        ...
        <Link href='/productos' ><Button radius="full" size="sm">Explora ya</Button></Link>
      </CardFooter>
    </Card>
  </div>
  );   
