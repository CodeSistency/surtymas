...
function Footer() {
  return (
    <footer Name="p-4 bg-white sm:p-6 dark:bg-gray-800 mt-16">
    <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
                <a href="https://flowbite.com" className="flex items-center">
                    <img src="/logo3.svg" className="mr-3 h-32 w-32" alt="FlowBite Logo" />
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul clasName="text-gray-600 dark:text-gray-400">
                        <li className="mb-4">
                ...
                <div>
                    ...
                    <ul className="text-gray-600 dark:text-gray-400">
                        ...
                        <li>
                            <a href="https://discord.gg/4eeurUVvTy" Name="hover:underline">TikTok</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul className="text-gray-600 dark:text-gray-400">
                        <li className="mb-4">
                            <a href="#" className="hover:underline">Politica y Privacidad</a>
                        </li>
                        <li>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span Name="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com" class="hover:underline">Surtymas™</a>. Todos los derechos reservados.
            </span>
