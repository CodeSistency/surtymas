    ...
    <div>
        ...
        <div className='flex flex-col gap-10 w-full'>
            <div className="w-full card-container">
                ...
                <Link href='/productos/tipo/croptop' className='foto-category '><Avatar className='lg:w-24 lg:h-24 sm:w-16 sm:h-16' isBordered src="/crop-top.jpg" /><p>Crop Top</p></Link>
