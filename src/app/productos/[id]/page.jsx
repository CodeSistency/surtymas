...
async function page({params}) {
  ...
  return (
    ...
    <div class=" gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:flex  sm:py-16 lg:px-6">
        ...
        <img class="w-full sm:max-h-[400px] flex-1 lg:h-full dark:hidden" src={product.imagenes[0]} alt="dashboard image"/>
        {/* <img class="w-full hidden dark:block" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/cta/cta-dashboard-mockup-dark.svg" alt="dashboard image"/> */}
        <div class="mt-4 md:mt-0 flex-1">
          
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">{product.titulo}</h2>
...
<div className='precios'>
              ...
              <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400"><strong className='font-extrabold text-gray-900'>Descripcion:</strong> {product?.descripcion}</p>
...
<h4 className='font-extrabold text-gray-900'>Tallas disponibles:</h4>
  ...
  <div class="max-w-2xl mx-auto px-4">
      <div class="flex justify-between items-center mb-6">
        <h2 class="text-lg lg:text-2xl font-bold text-gray-900 dark:text-white">Comentarios ({product.comentarios.length})</h2>
    </div>
    {/* <form class="mb-6">
    ...
    <CommentForm user={session?.user?.name} id={product._id}/>
    {
        ...
        <p class="text-gray-500 dark:text-gray-400">{comentario.comentario}</p>
